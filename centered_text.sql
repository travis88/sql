CREATE OR REPLACE FUNCTION common.centered_text(str character varying, max_length integer)
...
BEGIN
--	SELECT * FROM common.centered_text('Перец & Яковлев. Дудь, Колыма и репрессии. Закрыли тему.fdsf', 50);

	LOOP
		_str := (SELECT common.split_string(_str, max_length));
